...
from presentation_tool.fixer import ops
from presentation_tool.fixer.result import AppliedFix, FixResult
...
class AutoFixer:
    def fix(
        ...
        from presentation_tool.fixer.result import SplitSuggestion
